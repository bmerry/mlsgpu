...
void TestContainers::testAll()
{
    ...
    Peak &peakStxxlVector = Statistics::getStatistic<Peak>("mem.stxxlvector");
    ...
    CPPUNIT_ASSERT_EQUAL(stxxlVectorDiff + vectorDiff + setDiff + mapDiff, allDiff);
}
